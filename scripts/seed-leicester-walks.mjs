...
const walksSource = [
  ...
  { num: 206, title: "Atherstone — Bluebells & Beer", start: "Atherstone", end: "Atherstone", miles: 12.5, terrain: "Woodlands, country park, valley views.", sights: ["Hartshill Country Park", "Anker Valley"], bestTime: "Late April for bluebells.", lunch: [{ name: "Church End Brewery", location: "Ridge Lane" }] },
